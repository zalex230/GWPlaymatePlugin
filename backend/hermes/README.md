...
- `HERMES_USE_OLLAMA`
- `OLLAMA_HOST`
- `OLLAMA_MODEL` (default: `hermes-qwen35-4b-uncensored:latest`; build with `ollama create hermes-qwen35-4b-uncensored -f backend/hermes/ollama/Modelfile.hermes-qwen35-4b-uncensored`)
- `OLLAMA_NUM_CTX`
- `OLLAMA_NUM_PREDICT`
